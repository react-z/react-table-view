...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libTableView = __webpack_require__(157);

	var _libTableView2 = _interopRequireDefault(_libTableView);

	// must ensure all of your fields have values
	var DATA = [{ id: 0, make: 'Honda', model: 'NSX', year: '1997' }, { id: 1, make: 'Toyota', model: 'Supra', year: '1996' }, { id: 2, make: 'Nissan', model: '300ZX', year: '1998' }];
	...
	_react2['default'].render(_react2['default'].createElement(_libTableView2['default'], { data: DATA, columns: COLUMNS }), document.getElementById('container'));
	...
	**/
	var TableView = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement('div', { className: 'react-table-view' }, _react2['default'].createElement('table', null, _react2['default'].createElement('thead', null, _react2['default'].createElement('tr', null, this.state.fields.map((function (f) {
	      return _react2['default'].createElement('th', { onClick: this.sort, 'data-field-name': f }, _react2['default'].createElement('span', null, f), _react2['default'].createElement('div', { ref: f }));
	    }).bind(this)))), _react2['default'].createElement('tbody', null, this.props.data.map(function (d) {
	      return _react2['default'].createElement('tr', { key: d.id }, fields.map(function (f) {
	        if (columns && columns[f]) {
	          return _react2['default'].createElement('td', null, columns[f](d));
	        } else {
	          return _react2['default'].createElement('td', null, d[f]);
	        }
	      }));
	    }))));
	  }
