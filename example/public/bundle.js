	  ...
	  _createClass(TestComponent, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_TableView2.default, { data: DATA, columns: COLUMNS })
	      );
	    }
	  }]);
	...
	var TableView = function (_Component) {
	  ...
	  _createClass(TableView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { className: 'react-table-view' }, _react2.default.createElement('table', null, _react2.default.createElement('thead', null, _react2.default.createElement('tr', null, this.state.fields.map(function (f, i) {
	        return _react2.default.createElement('th', { ley: i, onClick: _this2.sort.bind(_this2), 'data-field-name': f }, _react2.default.createElement('span', null, f), _react2.default.createElement('div', { ref: f }));
	      }))), _react2.default.createElement('tbody', null, this.props.data.map(function (d) {
